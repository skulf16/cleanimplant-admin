        ...
        {profiles.map((profile) => {
          ...
          return (
            <div key={profile.id} className="space-y-4">
              ...
              <div className="rounded-xl overflow-hidden" style={{ background: "#f5f6f8" }}>
                <div className="px-6 pt-6 pb-2">
                  <h3 className="text-[15px] font-semibold text-[#333] mb-1">
                    Profil bearbeiten
                  </h3>
                  <p className="text-[12px] text-[#888]">
                    Änderungen werden nach dem Speichern auf Ihrer öffentlichen Profilseite sichtbar.
                  </p>
                </div>
                <div className="px-6 pb-6">
                  <MemberDoctorForm doctor={profile} />
                </div>
              </div>
            </div>
          );
